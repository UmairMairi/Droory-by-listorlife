...
class _ApartmentFormState extends State<ApartmentForm> {
  ...
  void initState() {
    ...
    if (widget.item != null && !widget.viewModel.hasInitializedForEdit) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        // Add this debug line
        print("DEBUG ApartmentForm: After updateTextFieldsItems");
        print(
            "DEBUG: adTitle = '${widget.viewModel.adTitleTextController.text}'");
        print(
            "DEBUG: propertyFor = '${widget.viewModel.propertyForTextController.text}'");
        print(
            "DEBUG: currentPropertyType = '${widget.viewModel.currentPropertyType}'");
      });
    }
  }
  ...
  double _getTextSize(BuildContext context) {
    ...
    return 11.0; // Smaller for English
  }
  ...
  void _performSubmit(BuildContext context) {
    ...
    if (widget.viewModel.levelTextController.text.isEmpty) {
      DialogHelper.showToast(message: StringHelper.plsSelectLevel);
      isValid = false;
    }

    // Add payment type validation for non-rent properties
        ...
        children: [
                  ...
                  return Column(
                    ...
                    children: [
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            _buildPropertyTypeOption(context,
                                StringHelper.apartment, Icons.apartment, field),
                            _buildPropertyTypeOption(context,
                                StringHelper.duplex, Icons.home_work, field),
                            ...
                            _buildPropertyTypeOption(
                                ...
                                Icons.hotel,
                                field),
                            _buildPropertyTypeOption(context, StringHelper.roof,
                                Icons.roofing, field),
                          ],
                        ),
                      ),
          ...
          AppTextField(
            ...
            validator: (value) {
              ...
              if (amount < 20) {
                return '* ${StringHelper.minValidAreaSize} 20';
              }
              if (amount > 1000000) {
            ...
            validator: (value) {
              ...
              if (widget.viewModel.currentPropertyType.toLowerCase() ==
                ...
                if (amount > 150000000) {
                  ...
                  "rent") {
                if (amount > 800000) {
                  return '* ${StringHelper.maxValidPrice} 800,000';
                }
              }
              return null;
            },
                        ...
                        validator: (value) {
                          if (value != null && value.trim().isNotEmpty) {
                            ...
                            if (rentAmount > 0 && amount > rentAmount) {
                              return '* Deposit cannot exceed monthly rent';
                            }
                          }
                          return null;
                        },
