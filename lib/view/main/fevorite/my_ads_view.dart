...
class MyAdsView extends BaseView<MyAdsVM> {
  ...
  Widget build(BuildContext context, MyAdsVM viewModel) {
    return DbHelper.getIsGuest()
      ...
      child: viewModel.isLoading ? MyAdsSkeleton(isLoading: viewModel.isLoading):
      viewModel.productsList.isNotEmpty ? ListView.separated(
        shrinkWrap: true,
        ...
        itemBuilder: (context, index) {
          return InkWell(
            onTap: () {
              context.push(Routes.myProduct, extra: viewModel.productsList[index]);
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(  viewModel.getCreatedAt(time: viewModel.productsList[index].createdAt),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                            flex: 6,
                            child: ImageView.rect(image: "${ApiConstants.imageUrl}/${viewModel.productsList[index].productMedias?.last.media}", width: 250, height: 100,borderRadius: 10,)),
                        const Gap(10),
                        Expanded(
                          flex: 7,
                          child: Column(
                            ...
                            children: [
                              Text(
                                viewModel.productsList[index].name ?? '',
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Gap(02),
                                    Text(
                                      'Likes: ${viewModel.productsList[index].countViews}',
                                      style: context.textTheme.labelMedium
                                          ?.copyWith(
                                          fontFamily:
