...
class _RateUsModalState extends State<RateUsModal> {
  ...
  void _openAppStore() async {
    const String appStoreUrl = "https://apps.apple.com/app/daroory/id123456789"; // Replace with your App Store URL
    const String playStoreUrl = "https://play.google.com/store/apps/details?id=com.yourapp.daroory"; // Replace with your Play Store URL
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Gap(16),
                Text(
                  StringHelper.enjoyingDaroory, // Assuming StringHelper is defined
                    ...
                    return GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: AnimatedContainer(
                          ...
                          transform: Matrix4.identity()..scale(selectedRating > index ? 1.2 : 1.0),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: selectedRating > 0
                            ? () async {
                                _confettiController.play(); // Confetti on submission
