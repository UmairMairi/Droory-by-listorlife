      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            FormField<String?>(
              initialValue: viewModel.workSettingTextController.text,
              builder: (field) {
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                      ...
                      children: [
                        ...
                        _buildSelectionOption(
                          ...
                          isSelected: viewModel.workSettingTextController.text ==
                              "Mixed (Home & Office)",
                          onTap: () {
                            field.didChange("Mixed (Home & Office)");
                            field.validate();
                            viewModel.workSettingTextController.text =
                                "Mixed (Home & Office)";
                            viewModel.notifyListeners();
