...
class IncludeMobileDetailView extends StatefulWidget {
  const IncludeMobileDetailView({super.key});

  @override
  State<IncludeMobileDetailView> createState() => _IncludeSomeDetailState();
}

class _IncludeSomeDetailState extends State<IncludeMobileDetailView> {
  Pattern pattern =
  ...
  TextEditingController numOfOwnerController = TextEditingController();
